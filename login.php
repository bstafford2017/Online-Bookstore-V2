<!doctype html>
    ...
    <body>
        ...
        <form id="form" class="offset-sm-4 col-sm-4">
            ...
            <button id="login" type="submit" class="btn btn-primary btn-dark col-sm-2">Login</button>
            <button id="signup" type="submit" class="btn btn-primary btn-dark col-sm-2" onclick="window.location='signup.php';">Sign Up</button>
        </form>
